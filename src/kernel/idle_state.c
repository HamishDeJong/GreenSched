...
void
green_idle_reset(struct green_idle_tracker *tracker)
{
...
void
green_idle_enter(struct green_idle_tracker *tracker, uint now_tick)
{
  /* Ignore invalid input or repeated idle entry. */
  if(tracker == 0 || tracker->in_idle)
    return;
...
void
green_idle_exit(struct green_idle_tracker *tracker, uint now_tick)
{
...
void
green_idle_on_tick(struct green_idle_tracker *tracker)
{
